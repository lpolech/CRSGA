...
public class FlatWithinPlusBetweenIndex extends CommonQualityMeasure {
    private DistanceMeasure dist;

    private FlatWithinPlusBetweenIndex() {}

    public FlatWithinPlusBetweenIndex(DistanceMeasure dist)
    {
        this.dist = dist;
    }

...
public class InitialPopulationGeneratorFactory {
  ...
  public BaseInitialPopulation createInitialPopulation(InitialPopulationType type) {
    ...
    switch (type) {
      ...
      case RANDOM_TTP:
        initialPopulation = new RandomTTPInitialPopulation<>();
        ((RandomTTPInitialPopulation) initialPopulation)
            .setMultiplicationFactor(parameters.populationMultiplicationFactor);
        return initialPopulation;
      case READ_TTP:
        return new ReadTTPInitialPopulation();
      case READ_MSRCPSP:
        return new ReadMSRCPSPInitialPopulation();
      default:

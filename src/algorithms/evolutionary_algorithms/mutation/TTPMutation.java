...
public class TTPMutation extends BaseMutation<Integer, BaseProblemRepresentation> {
   ...
   * @param f probability that the gene should be mutated
  ...
  public List<Integer> mutate(List<BaseIndividual<Integer, BaseProblemRepresentation>> population, double f, List<Integer> genesToMutate, int current, int populationSize, ParameterSet<Integer, BaseProblemRepresentation> parameters) {
    ...
    if(parameters.TSPmutationVersion == 1) {
      indWiseReverseMutationTSP(f, genesToMutate, parameters, splitPoint); // BASELINE
    } else if(parameters.TSPmutationVersion == 2) {
      indWiseReverseFixedLengthMutationTSP(f, genesToMutate, parameters, splitPoint, 40);
    } else if(parameters.TSPmutationVersion == 3) {
      geneWiseReverseMutationTSP(f, genesToMutate, parameters, splitPoint);
    } else if(parameters.TSPmutationVersion == 4) {
      indWiseDisplacementMutationTSP(f, genesToMutate, parameters, splitPoint);
    } else if(parameters.TSPmutationVersion == 5) {
      indWiseInversionDisplacementMutationTSP(f, genesToMutate, parameters, splitPoint);
    } else if(parameters.TSPmutationVersion == 6) {
      indWiseScrambleDisplacementMutationTSP(f, genesToMutate, parameters, splitPoint);
    } else if(parameters.TSPmutationVersion == 7) {
      indWiseScrambleMutationTSP(f, genesToMutate, parameters, splitPoint);
    } else if(parameters.TSPmutationVersion == 8) {
      indWiseInsertionMutationTSP(f, genesToMutate, parameters, splitPoint);
    } else if(parameters.TSPmutationVersion == 9) {
      geneWiseInsertionMutationTSP(f, genesToMutate, parameters, splitPoint);
    } else if(parameters.TSPmutationVersion == 10) {
      geneWiseBitSwapMutationTSP(f, genesToMutate, parameters, splitPoint);
    } else if(parameters.TSPmutationVersion == 11) {
      indWiseBitSwapMutationTSP(f, genesToMutate, parameters, splitPoint);
    }

    if(parameters.KNAPmutationVersion == 1) {
      geneWiseBitFlipMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint); // BASELINE
    } else if(parameters.KNAPmutationVersion == 2) { // NEW FAVOURITE
      indWiseBitFlipMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint, 1); // NEW FAVOURITE
    } else if(parameters.KNAPmutationVersion == 3) {
      indWiseReverseMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint);
    } else if(parameters.KNAPmutationVersion == 4) {
      indWiseReverseFixedLengthMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint, 30);
    } else if(parameters.KNAPmutationVersion == 5) {
      geneWiseReverseMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint);
    } else if(parameters.KNAPmutationVersion == 6) {
      indWiseDisplacementMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint);
    } else if(parameters.KNAPmutationVersion == 7) {
      indWiseInversionDisplacementMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint);
    } else if(parameters.KNAPmutationVersion == 8) {
      indWiseScrambleDisplacementMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint);
    } else if(parameters.KNAPmutationVersion == 9) {
      indWiseScrambleMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint);
    } else if(parameters.KNAPmutationVersion == 10) {
      indWiseInsertionMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint);
    } else if(parameters.KNAPmutationVersion == 11) {
      geneWiseInsertionMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint);
    } else if(parameters.KNAPmutationVersion == 12) {
      geneWiseBitSwapMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint);
    } else if(parameters.KNAPmutationVersion == 13) {
      indWiseBitSwapMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint);
    } else if(parameters.KNAPmutationVersion == 14) {
      indWiseBitFlipSeqMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint);
    } else if(parameters.KNAPmutationVersion == 15) {
      indWiseBitFlipSeqFixedLengthMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint, 40);
    } else if(parameters.KNAPmutationVersion == 16) {
      indWiseBitFlipSeqDisplacementMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint);
    } else if(parameters.KNAPmutationVersion == 17) {
      indWiseInversionDisplacementMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint);
    } else if(parameters.KNAPmutationVersion == 18) {
      indWiseBitFlipInsertionMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint);
    } else if(parameters.KNAPmutationVersion == 19) {
      geneWiseBitFlipInsertionMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint);
    } else if(parameters.KNAPmutationVersion == 20) {
      geneWiseInsertionMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint);
    } else if(parameters.KNAPmutationVersion == 21) {
      indWiseBitFlipMutationDynKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint, 2);
    } else if(parameters.KNAPmutationVersion == 22) {
      indWiseBitFlipMutationDynKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint, 3);
    } else if(parameters.KNAPmutationVersion == 23) {
      indWiseBitFlipMutationDynKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint, 4);
    }  else if(parameters.KNAPmutationVersion == 24) {
      indWiseBitFlipMutationDynKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint, 5);
    } else if(parameters.KNAPmutationVersion == 25) {
      indWiseBitFlipMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint, 2);
    } else if(parameters.KNAPmutationVersion == 26) {
      indWiseBitFlipMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint, 3);
    } else if(parameters.KNAPmutationVersion == 27) {
      indWiseBitFlipMutationKNAP(parameters.KNAPmutationProbability, genesToMutate, parameters, splitPoint, 4);
    }

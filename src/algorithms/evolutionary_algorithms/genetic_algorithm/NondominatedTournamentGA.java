...
//          }
                    ...
                    children.set(0, parameters.mutation.mutate(population, 0.1, children.get(0), 0, populationSize, parameters));
                    children.set(1, parameters.mutation.mutate(population, 0.1, children.get(1), 0, populationSize, parameters));
                }

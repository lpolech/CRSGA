...
public class NSGAIIManyBatchRunner {

  private static final Logger LOGGER = Logger.getLogger(NSGAIIManyBatchRunner.class.getName());
...
//            .setInputFile("init_research3/" + input + "/" + file.getName().split("\\.")[0] + ".init");

...
public class NSGARunner {

  private static final Logger LOGGER = Logger.getLogger(NSGARunner.class
      .getName());
...
//    try {
//      o = new java.io.PrintStream(new java.io.File("100_10_27_9_D2_NSGA-II.csv"));

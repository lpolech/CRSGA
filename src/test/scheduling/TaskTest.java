...
public class TaskTest {
  ...
  public void testToString() {
    Skill[] skills = {new Skill("Coding", 1)};
    int[] predecessors = {5, 7};
    Task task = new Task(1, skills, 10, 0, predecessors, 1);
  ...
  public void testEqualsWrongObject() {
    Skill[] skills = {new Skill("Coding", 1)};
    int[] predecessors = {5, 7};
    Task firstTask = new Task(1, skills, 10, predecessors);
  ...
  public void testEquals() {
    Skill[] skills = {new Skill("Coding", 1)};
    int[] predecessors = {5, 7};
    Task firstTask = new Task(1, skills, 10, 0, predecessors, 1);
